...
% Title page: Madrid theme renders title/author/date in palette-colored blocks
\setbeamercolor{palette primary}{bg=ippblue,fg=white}
\setbeamercolor{palette secondary}{bg=crestblue,fg=white}
